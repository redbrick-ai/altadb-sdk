...
from altadb.utils.rb_label_utils import (
    dicom_rb_format,
    parse_entry_latest,
    user_format,
    assignee_format,
)
from altadb.utils.rb_event_utils import task_event_format
from altadb.types.task import OutputTask as TypeTask, Series as TypeTaskSeries
...
class Export:
        ...
        try:  # pylint: disable=too-many-nested-blocks
            ...
            if task_series:
                ...
                if taxonomy.get("isNew") and rt_struct:
                    ...
                    from altadb.utils.dicom import convert_nii_to_rtstruct
    ...
    async def download_and_process_segmentations(
        ...
        from altadb.utils.dicom import process_nifti_download
