...
from altadb.utils.files import NIFTI_FILE_TYPES, download_files, upload_files
...
from altadb.types.task import InputTask, OutputTask
...
async def convert_rt_struct_to_nii_labels(
    ...
    from altadb.utils.dicom import convert_rtstruct_to_nii
...
async def process_segmentation_upload(
    ...
    from altadb.utils.dicom import process_nifti_upload
